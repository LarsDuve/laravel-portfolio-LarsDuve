...
<div id="box-container-body">
    <div id="box-mid-body">
        <div id="content">
            ...
            <p>Here are some questions listed that people frequently ask themselves.</p>
            <ul>
                <li><h3>How can you print a document from your laptop at HZ?</h3></li>
                <p>To print a document you go to 'print' and select the:'HP Color Laserjet'.</p>
                <li><h3>How can you scan a document a send it to your laptop at HZ?</h3></li>
                <p>You can scan a document at the scanner located in the building and send it to your e-mail address.</p>
